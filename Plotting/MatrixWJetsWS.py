...
def make_wjets_matrix( sampMan, sample, sel_base, eta_cut, isdata=False, suffix='', workspace=None) :
    ...
    fake_sel_sieie_incl = ' && '.join( [sel_base, ph_sel_basic, ph_pt_15To25, ph_sel_preid, chiso_fail_sel] ) #set pt cut here
    fake_sel_sieie_incl = '(' + fake_sel_sieie_incl + ')*' + myweight

    fake_sel_chiso_incl = ' && '.join( [sel_base, ph_sel_basic, ph_pt_15To25, ph_sel_preid, chiso_fail_sel] ) #set pt cut here
